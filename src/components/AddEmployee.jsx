...
const AddEmployee = () => {
    ...
    return (
        <div className='flex max-w-2xl mx-auto shadow-slate-900 border-b'>
            <div className="px-8 py-8">
                ...
                <div className="items-center justify-center h-14 w-full my-4">
                    ...
                    <input onChange={e => handleChange(e)} name='emailId' value={employee.emailId} type="email" className='h-10 w-96 border mt-2 px-2 py-2' />
                </div>
